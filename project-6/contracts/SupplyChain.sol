...
contract SupplyChain is RetailerRole, FarmerRole, DistributorRole, ConsumerRole{
    ...
    event RetailPriceUpdated(uint256 upc);
    ...
    modifier retailPriceUpdate(uint256 _upc) {
        require(items[_upc].itemState == State.UpdatedRetailPrice);
        _;
    }
    // Define a modifier that checks if an item.state of a upc is Purchased
    ...
    function updateRetailPrice(uint256 _upc, uint256 _retailPrice)
        public
        received(_upc)
        onlyRetailer
       
    {
         ...
         items[_upc].itemState=State.UpdatedRetailPrice;
         items[_upc].productPrice=_retailPrice;
         emit RetailPriceUpdated(_upc);
    ...
    
    {
       ...
       uint256 amountToReturn=msg.value-items[_upc].productPrice;
        ...
        checkValue(_upc)
    {
        ...
        address payable ownerAddressPayable = payable(items[_upc].retailerID);
